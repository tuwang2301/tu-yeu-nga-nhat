  ...
  return (
    <div className="min-h-screen w-full flex flex-col justify-center">
      ...
      <div className="w-full flex justify-between px-32">
        <div>
          {step > 1 && (
            <button
              ...
              className="bg-white text-black px-4 py-2 rounded-2xl flex disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer hover:shadow-2xl hover:opacity-80 transition ease-in duration-200 group"
            >
        ...
        <div>
          <button
            className="bg-black text-white px-4 py-2 rounded-2xl flex disabled: disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer hover:shadow-2xl hover:opacity-80 transition ease-in duration-200 group"
